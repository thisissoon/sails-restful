...
Connection.find = function find (connection, collection, options, cb) {
  ...
  var collectionObj = connection.collections[collection];

  var req = connection.service,
      url = collectionObj.url ? collectionObj.url : '/' + collection,
...
Connection.update = function update (connection, collection, options, values, cb) {
  ...
  var req = connection.service,
      url = collectionObj.url ? collectionObj.url + '/' + options.where.id : '/' + collection + '/' + options.where.id,
      headers = connection.headers;
